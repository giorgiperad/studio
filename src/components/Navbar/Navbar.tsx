...
const Navbar = () => (
  <nav style={{position:'fixed',top:0,left:0,width:'100%',padding:'30px 60px',display:'flex',justifyContent:'space-between',alignItems:'center',zIndex:1000,backdropFilter:'blur(20px)',background:'rgba(5,5,5,0.7)',borderBottom:'1px solid rgba(255,255,255,0.05)'}}>
