  ...
  return (
    <section
      ...
      <div className="flex flex-col justify-between gap-8">
        <div>
          <h3 className="text-neutral text-3xl font-bold">მოგვწერეთ</h3>
          <h4 className="text-accent text-2xl font-bold md:text-3xl">მოგვეცით საშუალება დაგეხმაროთ</h4>
        ...
        <div className="space-y-2">
          <p className="text-neutral text-lg font-bold">საკონტაქტო ინფორმაცია</p>
          <a
